...
export class AssetsAssetUpdatedEvent {
     ...
     * Asset info has been updated
     */
    get asV52(): [v52.AssetId32, (Uint8Array | undefined), (Uint8Array | undefined)] {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class AssetsMintEvent {
     ...
     *  Asset amount has been minted. [Issuer Account, Target Account, Minted Asset Id, Amount Minted]
     */
    get asV33(): [Uint8Array, Uint8Array, Uint8Array, bigint] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class BalancesBalanceSetEvent {
     ...
     *  A balance was set by root. \[who, free, reserved\]
     */
    get asV33(): [Uint8Array, bigint, bigint] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class BalancesReserveRepatriatedEvent {
     ...
     *  \[from, to, balance, destination_status\]
     */
    get asV33(): [Uint8Array, Uint8Array, bigint, v33.BalanceStatus] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class BridgeMultisigMultisigApprovalEvent {
     ...
     *  A multisig operation has been approved by someone. [approving, timepoint, multisig, call_hash]
     */
    get asV33(): [Uint8Array, v33.BridgeTimepoint, Uint8Array, Uint8Array] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BridgeMultisigMultisigExecutedEvent {
     ...
     *  A multisig operation has been executed. [approving, timepoint, multisig, call_hash]
     */
    get asV33(): [Uint8Array, v33.BridgeTimepoint, Uint8Array, Uint8Array, Result<v33.PostDispatchInfo, v33.DispatchErrorWithPostInfoTPostDispatchInfo>] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A multisig operation has been executed. [approving, timepoint, multisig, call_hash]
     */
    get asV52(): [Uint8Array, v52.BridgeTimepoint, Uint8Array, Uint8Array, (v52.DispatchError | undefined)] {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BridgeMultisigNewMultisigEvent {
     ...
     *  A new multisig operation has begun. [approving, multisig, call_hash]
     */
    get asV33(): [Uint8Array, Uint8Array, Uint8Array] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CeresGovernancePlatformCreatedEvent {
     ...
     *  Create poll [who, option, start_block, end_block]
     */
    get asV33(): [Uint8Array, number, number, number] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class CeresGovernancePlatformVotedEvent {
     ...
     *  Voting [who, poll, option, balance]
     */
    get asV33(): [Uint8Array, Uint8Array, number, bigint] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CeresLiquidityLockerLockedEvent {
     ...
     *  Funds Locked [who, amount, block]
     */
    get asV33(): [Uint8Array, bigint, number] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class CeresTokenLockerLockedEvent {
     ...
     *  Funds Locked [who, amount, asset]
     */
    get asV33(): [Uint8Array, bigint, Uint8Array] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class CouncilClosedEvent {
     ...
     *  \[proposal_hash, yes, no\]
     */
    get asV33(): [Uint8Array, number, number] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class CouncilExecutedEvent {
     ...
     *  \[proposal_hash, result\]
     */
    get asV33(): [Uint8Array, v33.DispatchResult] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A motion was executed; result will be `Ok` if it returned without error.
     */
    get asV52(): {proposalHash: Uint8Array, result: v52.Type_41} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CouncilProposedEvent {
     ...
     *  \[account, proposal_index, proposal_hash, threshold\]
     */
    get asV33(): [Uint8Array, number, Uint8Array, number] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class CouncilVotedEvent {
     ...
     *  \[account, proposal_hash, voted, yes, no\]
     */
    get asV33(): [Uint8Array, Uint8Array, boolean, number, number] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class DemocracyPreimageReapedEvent {
     ...
     *  \[proposal_hash, provider, deposit, reaper\]
     */
    get asV33(): [Uint8Array, Uint8Array, bigint, Uint8Array] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class DemocracyStartedEvent {
     ...
     *  A referendum has begun. \[ref_index, threshold\]
     */
    get asV33(): [number, v33.VoteThreshold] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class DemocracyTabledEvent {
     ...
     *  A public proposal has been tabled for referendum vote. \[proposal_index, deposit, depositors\]
     */
    get asV33(): [number, bigint, Uint8Array[]] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A public proposal has been tabled for referendum vote.
     */
    get asV52(): {proposalIndex: number, deposit: bigint} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyVetoedEvent {
     ...
     *  An external proposal has been vetoed. \[who, proposal_hash, until\]
     */
    get asV33(): [Uint8Array, Uint8Array, number] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class ElectionProviderMultiPhaseElectionFinalizedEvent {
     ...
     * The election has been finalized, with the given computation and score.
     */
    get asV52(): {compute: v52.ElectionCompute, score: v52.ElectionScore} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ElectionProviderMultiPhasePhaseTransitionedEvent {
     ...
     * There was a phase transition in a given round.
     */
    get asV52(): {from: v52.Phase, to: v52.Phase, round: number} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ElectionProviderMultiPhaseSolutionStoredEvent {
     ...
     * room for this one.
     */
    get asV52(): {compute: v52.ElectionCompute, origin: (Uint8Array | undefined), prevEjected: boolean} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class EthBridgeRegisterRequestFailedEvent {
     ...
     * The request registration has been failed. [Request Hash, Error]
     */
    get asV52(): [Uint8Array, v52.DispatchError] {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ImOnlineSomeOfflineEvent {
     ...
     *  At the end of the session, at least one validator was found to be \[offline\].
     */
    get asV33(): [Uint8Array, v33.FullIdentification][] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class LiquidityProxyExchangeEvent {
     ...
     *  [Caller Account, DEX Id, Input Asset Id, Output Asset Id, Input Amount, Output Amount, Fee Amount]
     */
    get asV33(): [Uint8Array, number, Uint8Array, Uint8Array, bigint, bigint, bigint] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class MulticollateralBondingCurvePoolOptionalRewardMultiplierUpdatedEvent {
     ...
     *  Multiplier for reward has been updated on particular asset. [Asset Id, New Multiplier]
     */
    get asV33(): [Uint8Array, (bigint | undefined)] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class MultisigMultisigApprovalEvent {
     ...
     *  \[approving, timepoint, multisig, call_hash\]
     */
    get asV33(): [Uint8Array, v33.Timepoint, Uint8Array, Uint8Array] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class MultisigMultisigExecutedEvent {
     ...
     *  A multisig operation has been executed. \[approving, timepoint, multisig, call_hash\]
     */
    get asV33(): [Uint8Array, v33.Timepoint, Uint8Array, Uint8Array, v33.DispatchResult] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A multisig operation has been executed.
     */
    get asV52(): {approving: Uint8Array, timepoint: v52.Timepoint, multisig: Uint8Array, callHash: Uint8Array, result: v52.Type_41} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class OffencesOffenceEvent {
     ...
     *  \[kind, timeslot, applied\].
     */
    get asV33(): [Uint8Array, Uint8Array, boolean] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class PswapDistributionFeesExchangeFailedEvent {
     ...
     *  [DEX Id, Fees Account Id, Fees Asset Id, Available Fees Amount, Incentive Asset Id]
     */
    get asV33(): [number, Uint8Array, Uint8Array, bigint, Uint8Array] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * [DEX Id, Fees Account Id, Fees Asset Id, Available Fees Amount, Incentive Asset Id, Exchange error]
     */
    get asV52(): [number, Uint8Array, v52.AssetId32, bigint, v52.AssetId32, v52.DispatchError] {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class PswapDistributionFeesExchangedEvent {
     ...
     *  [DEX Id, Fees Account Id, Fees Asset Id, Fees Spent Amount, Incentive Asset Id, Incentive Received Amount]
     */
    get asV33(): [number, Uint8Array, Uint8Array, bigint, Uint8Array, bigint] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class PswapDistributionIncentiveDistributedEvent {
     ...
     *  [DEX Id, Fees Account Id, Incentive Asset Id, Incentive Total Distributed Amount, Number of shareholders]
     */
    get asV33(): [number, Uint8Array, Uint8Array, bigint, bigint] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class PswapDistributionIncentivesBurnedAfterExchangeEvent {
     ...
     *  Incentives burned (Incentives that is not revived (to burn)]).
     */
    get asV33(): [number, Uint8Array, bigint, bigint] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class SchedulerCallUnavailableEvent {
     ...
     * The call for the provided hash was not found so the task has been aborted.
     */
    get asV52(): {task: [number, number], id: (Uint8Array | undefined)} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerDispatchedEvent {
     ...
     *  Dispatched some task. \[task, id, result\]
     */
    get asV33(): [[number, number], (Uint8Array | undefined), v33.DispatchResult] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * Dispatched some task.
     */
    get asV52(): {task: [number, number], id: (Uint8Array | undefined), result: v52.Type_41} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StakingBondedEvent {
     ...
     * it will not be emitted for staking rewards when they are added to stake.
     */
    get asV52(): {stash: Uint8Array, amount: bigint} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StakingEraPaidEvent {
     ...
     * the remainder from the maximum amount of reward.
     */
    get asV52(): {eraIndex: number, validatorPayout: bigint} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StakingKickedEvent {
     ...
     * A nominator has been kicked from a validator.
     */
    get asV52(): {nominator: Uint8Array, stash: Uint8Array} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StakingPayoutStartedEvent {
     ...
     * The stakers' rewards are getting paid.
     */
    get asV52(): {eraIndex: number, validatorStash: Uint8Array} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StakingSlashReportedEvent {
     ...
     * era as been reported.
     */
    get asV52(): {validator: Uint8Array, fraction: number, slashEra: number} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StakingSlashedEvent {
     ...
     * One staker (and potentially its nominators) has been slashed by the given amount.
     */
    get asV52(): {staker: Uint8Array, amount: bigint} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StakingValidatorPrefsSetEvent {
     ...
     * A validator has set their preferences.
     */
    get asV52(): {stash: Uint8Array, prefs: v52.ValidatorPrefs} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SubstrateBridgeOutboundChannelMessageAcceptedEvent {
    ...
    get asV57(): {networkId: v57.SubNetworkId, batchNonce: bigint, messageNonce: bigint} {
        assert(this.isV57)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SudoSudidEvent {
     ...
     * A sudo just took place. \[result\]
     */
    get asV52(): {sudoResult: v52.Type_41} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SystemExtrinsicFailedEvent {
     ...
     *  An extrinsic failed. \[error, info\]
     */
    get asV33(): [v33.DispatchError, v33.DispatchInfo] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * An extrinsic failed.
     */
    get asV52(): {dispatchError: v52.DispatchError, dispatchInfo: v52.DispatchInfo} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SystemExtrinsicSuccessEvent {
     ...
     * An extrinsic completed successfully.
     */
    get asV52(): {dispatchInfo: v52.DispatchInfo} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokensLockedEvent {
     ...
     * Some free balance was locked.
     */
    get asV52(): {currencyId: v52.AssetId32, who: Uint8Array, amount: bigint} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TradingPairTradingPairStoredEvent {
     ...
     *  Trading pair has been redistered on a DEX. [DEX Id, Trading Pair]
     */
    get asV33(): [number, v33.TradingPair] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
...
export class TransactionPaymentTransactionFeePaidEvent {
     ...
     * has been paid by `who`.
     */
    get asV52(): {who: Uint8Array, actualFee: bigint, tip: bigint} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class UtilityBatchInterruptedEvent {
     ...
     *  well as the error. \[index, error\]
     */
    get asV33(): [number, v33.DispatchError] {
        assert(this.isV33)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * well as the error.
     */
    get asV52(): {index: number, error: v52.DispatchError} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class UtilityItemFailedEvent {
     ...
     * A single item within a Batch of dispatches has completed with error.
     */
    get asV52(): {error: v52.DispatchError} {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class VestedRewardsCrowdloanClaimedEvent {
     ...
     * Claimed crowdloan rewards
     */
    get asV52(): [Uint8Array, v52.AssetId32, bigint] {
        assert(this.isV52)
        return this._chain.decodeEvent(this.event)
    }
}
