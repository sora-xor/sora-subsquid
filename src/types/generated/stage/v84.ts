...
export type Type_553 = Type_553_BaseFeeUpdate | Type_553_Inbound | Type_553_Outbound | Type_553_StatusReport

export interface Type_553_BaseFeeUpdate {
    __kind: 'BaseFeeUpdate'
    value: BaseFeeUpdate
}

export interface Type_553_Inbound {
    __kind: 'Inbound'
    value: InboundCommitment
}

export interface Type_553_Outbound {
    __kind: 'Outbound'
    value: OutboundCommitment
}

export interface Type_553_StatusReport {
    __kind: 'StatusReport'
    value: StatusReport
}
...
export type Type_572 = Type_572_Sidechain | Type_572_Thischain

export interface Type_572_Sidechain {
    __kind: 'Sidechain'
}

export interface Type_572_Thischain {
    __kind: 'Thischain'
}
...
export type Type_297 = Type_297_Noop | Type_297_Remove | Type_297_Set
...
export type Event = Event_Assets | Event_BagsList | Event_Balances | Event_Band | Event_BridgeDataSigner | Event_BridgeMultisig | Event_BridgeProxy | Event_CeresGovernancePlatform | Event_CeresLaunchpad | Event_CeresLiquidityLocker | Event_CeresStaking | Event_CeresTokenLocker | Event_Council | Event_DEXAPI | Event_DemeterFarmingPlatform | Event_Democracy | Event_ElectionProviderMultiPhase | Event_ElectionsPhragmen | Event_EthBridge | Event_Farming | Event_Grandpa | Event_HermesGovernancePlatform | Event_Identity | Event_ImOnline | Event_IrohaMigration | Event_Kensetsu | Event_LeafProvider | Event_LiquidityProxy | Event_MulticollateralBondingCurvePool | Event_Multisig | Event_MultisigVerifier | Event_Offences | Event_OracleProxy | Event_OrderBook | Event_ParachainBridgeApp | Event_Permissions | Event_PoolXYK | Event_Preimage | Event_PriceTools | Event_PswapDistribution | Event_Rewards | Event_Scheduler | Event_Session | Event_Staking | Event_SubstrateBridgeApp | Event_SubstrateBridgeInboundChannel | Event_SubstrateBridgeOutboundChannel | Event_SubstrateDispatch | Event_System | Event_Technical | Event_TechnicalCommittee | Event_TechnicalMembership | Event_Tokens | Event_TradingPair | Event_TransactionPayment | Event_Utility | Event_VestedRewards | Event_XSTPool | Event_XorFee
