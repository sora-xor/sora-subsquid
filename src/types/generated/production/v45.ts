 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetsCall = AssetsCall_register | AssetsCall_transfer | AssetsCall_mint | AssetsCall_force_mint | AssetsCall_burn | AssetsCall_set_non_mintable
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type VestedRewardsCall = VestedRewardsCall_claim_rewards | VestedRewardsCall_claim_crowdloan_rewards
...
export type Type_223 = Type_223_Noop | Type_223_Set | Type_223_Remove
...
export type Type_224 = Type_224_Noop | Type_224_Set | Type_224_Remove
 ...
 */
export type VestedRewardsEvent = VestedRewardsEvent_RewardsVested | VestedRewardsEvent_ActualDoesntMatchAvailable | VestedRewardsEvent_FailedToSaveCalculatedReward
