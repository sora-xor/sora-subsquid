...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_291
    maxValidatorCount: Type_291
    chillThreshold: Type_292
    minCommission: Type_293
}
...
export type Type_559 = Type_559_Sidechain | Type_559_Thischain

export interface Type_559_Sidechain {
    __kind: 'Sidechain'
}

export interface Type_559_Thischain {
    __kind: 'Thischain'
}
...
export type Event = Event_Assets | Event_BagsList | Event_Balances | Event_Band | Event_BridgeDataSigner | Event_BridgeMultisig | Event_BridgeProxy | Event_CeresGovernancePlatform | Event_CeresLaunchpad | Event_CeresLiquidityLocker | Event_CeresStaking | Event_CeresTokenLocker | Event_Council | Event_DEXAPI | Event_DemeterFarmingPlatform | Event_Democracy | Event_ElectionProviderMultiPhase | Event_ElectionsPhragmen | Event_EthBridge | Event_Grandpa | Event_HermesGovernancePlatform | Event_Identity | Event_ImOnline | Event_IrohaMigration | Event_LeafProvider | Event_LiquidityProxy | Event_MulticollateralBondingCurvePool | Event_Multisig | Event_MultisigVerifier | Event_Offences | Event_OracleProxy | Event_OrderBook | Event_ParachainBridgeApp | Event_Permissions | Event_PoolXYK | Event_Preimage | Event_PriceTools | Event_PswapDistribution | Event_Rewards | Event_Scheduler | Event_Session | Event_Staking | Event_SubstrateBridgeInboundChannel | Event_SubstrateBridgeOutboundChannel | Event_SubstrateDispatch | Event_System | Event_Technical | Event_TechnicalCommittee | Event_TechnicalMembership | Event_Tokens | Event_TradingPair | Event_TransactionPayment | Event_Utility | Event_VestedRewards | Event_XSTPool | Event_XorFee
...
export type Type_198 = Type_198_ApplyExtrinsic | Type_198_Finalization | Type_198_Initialization

export interface Type_198_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_198_Finalization {
    __kind: 'Finalization'
}

export interface Type_198_Initialization {
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        Council: Type_282,
        SubstrateDispatch: Type_284,
        TechnicalCommittee: Type_283,
        Void: Void,
        system: RawOrigin,
    }
})
