...
export const proposals =  {
     ...
     */
    v85: new StorageType('Council.Proposals', 'Default', [], sts.array(() => v85.H256)) as ProposalsV85,
}
...
export const proposalOf =  {
     ...
     */
    v85: new StorageType('Council.ProposalOf', 'Optional', [v85.H256], v85.Call) as ProposalOfV85,
}
...
export const voting =  {
     ...
     */
    v85: new StorageType('Council.Voting', 'Optional', [v85.H256], v85.Votes) as VotingV85,
}
...
export const proposalCount =  {
     ...
     *  Proposals so far.
     */
    v85: new StorageType('Council.ProposalCount', 'Default', [], sts.number()) as ProposalCountV85,
}
...
export const members =  {
     ...
     */
    v85: new StorageType('Council.Members', 'Default', [], sts.array(() => v85.AccountId32)) as MembersV85,
}
...
export const prime =  {
     ...
     */
    v85: new StorageType('Council.Prime', 'Optional', [], v85.AccountId32) as PrimeV85,
}
