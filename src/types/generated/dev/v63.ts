...
export type GenericNetworkId = GenericNetworkId_EVM | GenericNetworkId_Sub | GenericNetworkId_EVMLegacy
...
export type MessageStatus = MessageStatus_InQueue | MessageStatus_Committed | MessageStatus_Done | MessageStatus_Failed | MessageStatus_Refunded | MessageStatus_Approved
...
export type OrderBookStatus = OrderBookStatus_Trade | OrderBookStatus_PlaceAndCancel | OrderBookStatus_OnlyCancel | OrderBookStatus_Stop
...
export type GenericAccount = GenericAccount_EVM | GenericAccount_Sora | GenericAccount_Parachain | GenericAccount_Unknown | GenericAccount_Root
...
export type TechPurpose = TechPurpose_FeeCollector | TechPurpose_FeeCollectorForPair | TechPurpose_XykLiquidityKeeper | TechPurpose_Identifier | TechPurpose_OrderBookLiquidityKeeper
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type XSTPoolCall = XSTPoolCall_set_reference_asset | XSTPoolCall_enable_synthetic_asset | XSTPoolCall_register_synthetic_asset | XSTPoolCall_disable_synthetic_asset | XSTPoolCall_remove_synthetic_asset | XSTPoolCall_set_synthetic_asset_fee | XSTPoolCall_set_synthetic_base_asset_floor_price
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BandCall = BandCall_relay | BandCall_force_relay | BandCall_add_relayers | BandCall_remove_relayers | BandCall_set_dynamic_fee_parameters
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type OrderBookCall = OrderBookCall_create_orderbook | OrderBookCall_delete_orderbook | OrderBookCall_update_orderbook | OrderBookCall_change_orderbook_status | OrderBookCall_place_limit_order | OrderBookCall_cancel_limit_order | OrderBookCall_cancel_limit_orders_batch | OrderBookCall_execute_market_order
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BridgeProxyCall = BridgeProxyCall_burn | BridgeProxyCall_add_limited_asset | BridgeProxyCall_remove_limited_asset | BridgeProxyCall_update_transfer_limit
 ...
 */
export type BridgeInboundChannelCall = BridgeInboundChannelCall_submit | BridgeInboundChannelCall_batch_dispatched | BridgeInboundChannelCall_register_channel | BridgeInboundChannelCall_set_reward_fraction
...
export interface MigrationAppCall_migrate_erc20 {
    ...
    networkId: bigint
    erc20Assets: [AssetId32, Uint8Array, number][]
}

export interface MigrationAppCall_migrate_sidechain {
    __kind: 'migrate_sidechain'
    networkId: bigint
    sidechainAssets: [AssetId32, Uint8Array, number][]
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BridgeDataSignerCall = BridgeDataSignerCall_register_network | BridgeDataSignerCall_approve | BridgeDataSignerCall_add_peer | BridgeDataSignerCall_remove_peer | BridgeDataSignerCall_finish_remove_peer | BridgeDataSignerCall_finish_add_peer
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type MultisigVerifierCall = MultisigVerifierCall_initialize | MultisigVerifierCall_add_peer | MultisigVerifierCall_remove_peer
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type QAToolsCall = QAToolsCall_add_to_whitelist | QAToolsCall_remove_from_whitelist | QAToolsCall_order_book_create_empty_batch | QAToolsCall_order_book_create_and_fill_batch
...
export interface QAToolsCall_order_book_create_and_fill_batch {
    ...
    bidsOwner: Uint8Array
    asksOwner: Uint8Array
 ...
 */
export type XSTPoolEvent = XSTPoolEvent_ReferenceAssetChanged | XSTPoolEvent_SyntheticAssetEnabled | XSTPoolEvent_SyntheticAssetDisabled | XSTPoolEvent_SyntheticAssetFeeChanged | XSTPoolEvent_SyntheticBaseAssetFloorPriceChanged | XSTPoolEvent_SyntheticAssetRemoved
 ...
 */
export type OrderBookEvent = OrderBookEvent_OrderBookCreated | OrderBookEvent_OrderBookDeleted | OrderBookEvent_OrderBookStatusChanged | OrderBookEvent_OrderBookUpdated | OrderBookEvent_LimitOrderPlaced | OrderBookEvent_LimitOrderConvertedToMarketOrder | OrderBookEvent_LimitOrderIsSplitIntoMarketOrderAndLimitOrder | OrderBookEvent_LimitOrderCanceled | OrderBookEvent_LimitOrderExpired | OrderBookEvent_ExpirationFailure | OrderBookEvent_LimitOrderExecuted | OrderBookEvent_LimitOrderUpdated | OrderBookEvent_MarketOrderExecuted
 ...
 */
export interface OrderBookEvent_LimitOrderExpired {
    __kind: 'LimitOrderExpired'
    orderBookId: OrderBookId
    orderId: bigint
    ownerId: Uint8Array
}
 ...
 */
export type BridgeProxyEvent = BridgeProxyEvent_RequestStatusUpdate | BridgeProxyEvent_RefundFailed
 ...
 */
export type BridgeDataSignerEvent = BridgeDataSignerEvent_Initialized | BridgeDataSignerEvent_AddedPeer | BridgeDataSignerEvent_RemovedPeer | BridgeDataSignerEvent_ApprovalAccepted | BridgeDataSignerEvent_Approved
 ...
 */
export type MultisigVerifierEvent = MultisigVerifierEvent_NetworkInitialized | MultisigVerifierEvent_VerificationSuccessful | MultisigVerifierEvent_PeerAdded | MultisigVerifierEvent_PeerRemoved
