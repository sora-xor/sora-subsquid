...
export const registerBridge =  {
    ...
    v85: new CallType(
        ...
        sts.struct({
            bridgeContractAddress: v85.H160,
            initialPeers: sts.array(() => v85.AccountId32),
            signatureVersion: v85.BridgeSignatureVersion,
        })
    ),
}
...
export const removePeer =  {
    ...
    v85: new CallType(
        ...
        sts.struct({
            accountId: v85.AccountId32,
            peerAddress: sts.option(() => v85.H160),
            networkId: sts.number(),
        })
    ),
}
...
export const migrate =  {
    ...
    v85: new CallType(
        'EthBridge.migrate',
        sts.struct({
            newContractAddress: v85.H160,
            erc20NativeTokens: sts.array(() => v85.H160),
            networkId: sts.number(),
            newSignatureVersion: v85.BridgeSignatureVersion,
        })
    ),
}
...
export const registerIncomingRequest =  {
    ...
    v85: new CallType(
        ...
        sts.struct({
            incomingRequest: v85.IncomingRequest,
        })
    ),
}
...
export const importIncomingRequest =  {
    ...
    v85: new CallType(
        ...
        sts.struct({
            loadIncomingRequest: v85.LoadIncomingRequest,
            incomingRequestResult: sts.result(() => v85.IncomingRequest, () => v85.DispatchError),
        })
    ),
}
...
export const approveRequest =  {
    ...
    v85: new CallType(
        ...
        sts.struct({
            ocwPublic: sts.bytes(),
            hash: v85.H256,
            signatureParams: v85.SignatureParams,
            networkId: sts.number(),
        })
    ),
}
