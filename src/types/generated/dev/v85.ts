...
export interface PoolInfo {
    ...
    basicLendingRate: bigint
    profitLendingRate: bigint
    borrowingRate: bigint
    borrowingRewardsRate: bigint
    loanToValue: bigint
...
export const PoolInfo: sts.Type<PoolInfo> = sts.struct(() => {
    return  {
        totalLiquidity: sts.bigint(),
        totalBorrowed: sts.bigint(),
        totalCollateral: sts.bigint(),
        basicLendingRate: sts.bigint(),
        profitLendingRate: sts.bigint(),
        borrowingRate: sts.bigint(),
        borrowingRewardsRate: sts.bigint(),
...
export interface BorrowingPosition {
    ...
    borrowingAmount: bigint
    borrowingInterest: bigint
    lastBorrowingBlock: number
    borrowingRewards: bigint
}

export const BorrowingPosition: sts.Type<BorrowingPosition> = sts.struct(() => {
    return  {
        collateralAmount: sts.bigint(),
        borrowingAmount: sts.bigint(),
        borrowingInterest: sts.bigint(),
        lastBorrowingBlock: sts.number(),
        borrowingRewards: sts.bigint(),
    }
})

export interface LendingPosition {
    lendingAmount: bigint
    lendingInterest: bigint
    lastLendingBlock: number
}

export const LendingPosition: sts.Type<LendingPosition> = sts.struct(() => {
    return  {
        lendingAmount: sts.bigint(),
        lendingInterest: sts.bigint(),
        lastLendingBlock: sts.number(),
    }
})

export type GenericAssetId = GenericAssetId_EVM | GenericAssetId_Liberland | GenericAssetId_Sora | GenericAssetId_XCM

export interface GenericAssetId_EVM {
    __kind: 'EVM'
    value: H160
}

export interface GenericAssetId_Liberland {
    __kind: 'Liberland'
    value: LiberlandAssetId
}

export interface GenericAssetId_Sora {
    __kind: 'Sora'
    value: H256
}

export interface GenericAssetId_XCM {
    __kind: 'XCM'
    value: V3AssetId
}
...
export type LiberlandAssetId = LiberlandAssetId_Asset | LiberlandAssetId_LLD

export interface LiberlandAssetId_Asset {
    __kind: 'Asset'
    value: number
}

export interface LiberlandAssetId_LLD {
    __kind: 'LLD'
}
...
export const BaseFeeInfo: sts.Type<BaseFeeInfo> = sts.struct(() => {
    return  {
        baseFee: sts.bigint(),
        updated: sts.number(),
        evmBlockNumber: sts.bigint(),
    }
})

export type Type_615 = Type_615_Sidechain | Type_615_Thischain

export interface Type_615_Sidechain {
    __kind: 'Sidechain'
}

export interface Type_615_Thischain {
    __kind: 'Thischain'
}
...
export type Type_576 = Type_576_BaseFeeUpdate | Type_576_Inbound | Type_576_Outbound | Type_576_StatusReport

export interface Type_576_BaseFeeUpdate {
    __kind: 'BaseFeeUpdate'
    value: BaseFeeUpdate
}

export interface Type_576_Inbound {
    __kind: 'Inbound'
    value: InboundCommitment
}

export interface Type_576_Outbound {
    __kind: 'Outbound'
    value: OutboundCommitment
}

export interface Type_576_StatusReport {
    __kind: 'StatusReport'
    value: StatusReport
}
...
export interface OutboundCommitment {
    nonce: bigint
    totalMaxGas: bigint
    messages: Message[]
}
...
export interface InboundCommitment {
    channel: H160
    source: H160
    nonce: bigint
    blockNumber: bigint
...
export interface BaseFeeUpdate {
    newBaseFee: bigint
    evmBlockNumber: bigint
}
...
export type GenericBridgeMessage = GenericBridgeMessage_EVM | GenericBridgeMessage_Sub

export interface GenericBridgeMessage_EVM {
    __kind: 'EVM'
    value: Message
}

export interface GenericBridgeMessage_Sub {
    __kind: 'Sub'
    value: BridgeMessage
}

export const GenericBridgeMessage: sts.Type<GenericBridgeMessage> = sts.closedEnum(() => {
    return  {
        EVM: Message,
        Sub: BridgeMessage,
    }
...
export type GenericAccount = GenericAccount_EVM | GenericAccount_Liberland | GenericAccount_Parachain | GenericAccount_Root | GenericAccount_Sora | GenericAccount_Unknown
...
export interface GenericAccount_Liberland {
    __kind: 'Liberland'
    value: AccountId32
}
...
export interface CollateralizedDebtPosition {
    owner: AccountId32
    collateralAssetId: AssetId32
    collateralAmount: bigint
    debt: bigint
    interestCoefficient: FixedU128
}

export const CollateralizedDebtPosition: sts.Type<CollateralizedDebtPosition> = sts.struct(() => {
    return  {
        owner: AccountId32,
        collateralAssetId: AssetId32,
        collateralAmount: sts.bigint(),
...
export interface CollateralInfo {
    riskParameters: CollateralRiskParameters
    totalCollateral: bigint
    kusdSupply: bigint
    lastFeeUpdateTime: bigint
    interestCoefficient: FixedU128
}
...
export interface CollateralRiskParameters {
    ...
    maxLiquidationLot: bigint
    stabilityFeeRate: FixedU128
    minimalCollateralDeposit: bigint
}
...
export const CollateralInfo: sts.Type<CollateralInfo> = sts.struct(() => {
    return  {
        riskParameters: CollateralRiskParameters,
        totalCollateral: sts.bigint(),
        kusdSupply: sts.bigint(),
        lastFeeUpdateTime: sts.bigint(),
        interestCoefficient: FixedU128,
    }
})
...
export type Type_862 = Type_862_Requested | Type_862_Unrequested

export interface Type_862_Requested {
    __kind: 'Requested'
...
export interface Type_862_Unrequested {
    __kind: 'Unrequested'
    deposit: [AccountId32, bigint]
    len: number
}

export const Type_862: sts.Type<Type_862> = sts.closedEnum(() => {
    return  {
...
export type Type_860 = Type_860_V1 | Type_860_V2

export interface Type_860_V1 {
    __kind: 'V1'
}

export interface Type_860_V2 {
    __kind: 'V2'
}

export const Type_860: sts.Type<Type_860> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
    }
...
export type Type_834 = Type_834_V1 | Type_834_V2

export interface Type_834_V1 {
    __kind: 'V1'
}

export interface Type_834_V2 {
    __kind: 'V2'
}

export const Type_834: sts.Type<Type_834> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
    }
...
export type Type_821 = Type_821_V1 | Type_821_V2 | Type_821_V3

export interface Type_821_V1 {
    __kind: 'V1'
}

export interface Type_821_V2 {
    __kind: 'V2'
}

export interface Type_821_V3 {
    __kind: 'V3'
}

export const Type_821: sts.Type<Type_821> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
        V3: sts.unit(),
...
export type Type_814 = Type_814_V1 | Type_814_V2

export interface Type_814_V1 {
    __kind: 'V1'
}

export interface Type_814_V2 {
    __kind: 'V2'
}

export const Type_814: sts.Type<Type_814> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
    }
...
export const Type_784: sts.Type<Type_784> = sts.struct(() => {
    return  {
        limit: sts.bigint(),
...
export const Type_766: sts.Type<Type_766> = sts.struct(() => {
    return  {
        when: Timepoint,
        deposit: sts.bigint(),
        depositor: AccountId32,
...
export type Call = Call_ApolloPlatform | Call_Assets | Call_Babe | Call_BagsList | Call_Band | Call_BeefyLightClient | Call_BridgeDataSigner | Call_BridgeInboundChannel | Call_BridgeMultisig | Call_BridgeProxy | Call_CeresGovernancePlatform | Call_CeresLaunchpad | Call_CeresLiquidityLocker | Call_CeresStaking | Call_CeresTokenLocker | Call_Council | Call_DEXAPI | Call_DemeterFarmingPlatform | Call_Democracy | Call_EVMFungibleApp | Call_ElectionProviderMultiPhase | Call_ElectionsPhragmen | Call_EthBridge | Call_Farming | Call_Faucet | Call_Grandpa | Call_HermesGovernancePlatform | Call_Identity | Call_ImOnline | Call_IrohaMigration | Call_Kensetsu | Call_LiquidityProxy | Call_MulticollateralBondingCurvePool | Call_Multisig | Call_MultisigVerifier | Call_OracleProxy | Call_OrderBook | Call_ParachainBridgeApp | Call_Permissions | Call_PoolXYK | Call_Preimage | Call_PswapDistribution | Call_QaTools | Call_Referrals | Call_Rewards | Call_Scheduler | Call_Session | Call_Staking | Call_SubstrateBridgeApp | Call_SubstrateBridgeInboundChannel | Call_SubstrateBridgeOutboundChannel | Call_Sudo | Call_System | Call_Technical | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_TradingPair | Call_Utility | Call_VestedRewards | Call_XSTPool | Call_XorFee

export interface Call_ApolloPlatform {
    __kind: 'ApolloPlatform'
    value: ApolloPlatformCall
}
...
export interface Call_EVMFungibleApp {
    __kind: 'EVMFungibleApp'
    value: EVMFungibleAppCall
}
...
export interface Call_Kensetsu {
    __kind: 'Kensetsu'
    value: KensetsuCall
}
...
export interface Call_SubstrateBridgeOutboundChannel {
    __kind: 'SubstrateBridgeOutboundChannel'
    value: SubstrateBridgeOutboundChannelCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type SubstrateBridgeOutboundChannelCall = SubstrateBridgeOutboundChannelCall_update_interval

export interface SubstrateBridgeOutboundChannelCall_update_interval {
    __kind: 'update_interval'
    newInterval: number
}
...
export type MultiProof = MultiProof_Beefy | MultiProof_EVMMultisig | MultiProof_Multisig
...
export interface MultiProof_EVMMultisig {
    __kind: 'EVMMultisig'
    value: MultiEVMProof
}
...
export interface MultiEVMProof {
    proof: Signature[]
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type SubstrateBridgeAppCall = SubstrateBridgeAppCall_burn | SubstrateBridgeAppCall_finalize_asset_registration | SubstrateBridgeAppCall_incoming_thischain_asset_registration | SubstrateBridgeAppCall_mint | SubstrateBridgeAppCall_register_sidechain_asset | SubstrateBridgeAppCall_update_transaction_status
...
export interface SubstrateBridgeAppCall_finalize_asset_registration {
    ...
    assetId: AssetId32
    sidechainAssetId: GenericAssetId
    assetKind: Type_615
 ...
 */
export interface SubstrateBridgeAppCall_incoming_thischain_asset_registration {
    __kind: 'incoming_thischain_asset_registration'
    assetId: AssetId32
    sidechainAssetId: GenericAssetId
}
...
export type GenericBalance = GenericBalance_EVM | GenericBalance_Substrate

export interface GenericBalance_EVM {
    __kind: 'EVM'
    value: H256
}

export interface GenericBalance_Substrate {
    __kind: 'Substrate'
    value: bigint
}
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_318
    maxValidatorCount: Type_318
    chillThreshold: Type_319
    minCommission: Type_320
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type QaToolsCall = QaToolsCall_mcbc_initialize | QaToolsCall_order_book_create_and_fill_batch | QaToolsCall_order_book_fill_batch | QaToolsCall_price_tools_set_asset_price | QaToolsCall_xst_initialize | QaToolsCall_xyk_initialize
 ...
 */
export interface QaToolsCall_mcbc_initialize {
    __kind: 'mcbc_initialize'
    baseSupply?: (BaseSupply | undefined)
    otherCollaterals: OtherCollateralInput[]
    tbcdCollateral?: (TbcdCollateralInput | undefined)
}
...
export interface QaToolsCall_order_book_create_and_fill_batch {
    ...
    settings: [OrderBookId, OrderBookAttributes, FillInput][]
}
...
export interface QaToolsCall_order_book_fill_batch {
    ...
    bidsOwner: AccountId32
    asksOwner: AccountId32
    settings: [OrderBookId, FillInput][]
}
 ...
 */
export interface QaToolsCall_price_tools_set_asset_price {
    __kind: 'price_tools_set_asset_price'
    assetPerXor: AssetPrices
 ...
 */
export interface QaToolsCall_xst_initialize {
    __kind: 'xst_initialize'
    basePrices?: (BaseInput | undefined)
    syntheticsPrices: SyntheticInput[]
    relayer: AccountId32
}
 ...
 */
export interface QaToolsCall_xyk_initialize {
    __kind: 'xyk_initialize'
    account: AccountId32
    pairs: AssetPairInput[]
}

export interface AssetPairInput {
    dexId: number
    assetA: AssetId32
    assetB: AssetId32
    price: bigint
    maybeAssetAReserves?: (bigint | undefined)
}

export interface SyntheticInput {
    assetId: AssetId32
    expectedQuote: SyntheticQuote
    existence: SyntheticExistence
}

export type SyntheticExistence = SyntheticExistence_AlreadyExists | SyntheticExistence_RegisterNewAsset

export interface SyntheticExistence_AlreadyExists {
    __kind: 'AlreadyExists'
}

export interface SyntheticExistence_RegisterNewAsset {
    __kind: 'RegisterNewAsset'
    symbol: AssetSymbol
    name: AssetName
    referenceSymbol: SymbolName
    feeRatio: FixedPoint
...
export interface SyntheticQuote {
    direction: SyntheticQuoteDirection
    amount: QuoteAmount
    result: bigint
}

export type QuoteAmount = QuoteAmount_WithDesiredInput | QuoteAmount_WithDesiredOutput

export interface QuoteAmount_WithDesiredInput {
    __kind: 'WithDesiredInput'
    desiredAmountIn: bigint
}

export interface QuoteAmount_WithDesiredOutput {
    __kind: 'WithDesiredOutput'
    desiredAmountOut: bigint
}

export type SyntheticQuoteDirection = SyntheticQuoteDirection_SyntheticBaseToSynthetic | SyntheticQuoteDirection_SyntheticToSyntheticBase

export interface SyntheticQuoteDirection_SyntheticBaseToSynthetic {
    __kind: 'SyntheticBaseToSynthetic'
}

export interface SyntheticQuoteDirection_SyntheticToSyntheticBase {
    __kind: 'SyntheticToSyntheticBase'
}

export interface BaseInput {
    referencePerSyntheticBaseBuy: bigint
    referencePerSyntheticBaseSell: bigint
}

export type InputAssetId = InputAssetId_McbcReference | InputAssetId_Other | InputAssetId_XstReference

export interface InputAssetId_McbcReference {
    __kind: 'McbcReference'
}

export interface InputAssetId_Other {
    __kind: 'Other'
    value: AssetId32
}

export interface InputAssetId_XstReference {
    __kind: 'XstReference'
}
...
export interface FillInput {
    asks?: (SideFillInput | undefined)
    bids?: (SideFillInput | undefined)
    randomSeed?: (number | undefined)
}

export interface SideFillInput {
    highestPrice: bigint
    lowestPrice: bigint
    priceStep: bigint
...
export interface TbcdCollateralInput {
    parameters: CollateralCommonParameters
    refXorPrices?: (AssetPrices | undefined)
}

export interface CollateralCommonParameters {
    refPrices?: (AssetPrices | undefined)
    reserves?: (bigint | undefined)
}

export interface OtherCollateralInput {
    asset: AssetId32
    parameters: CollateralCommonParameters
}
...
export interface LiquidityProxyCall_xorless_transfer {
    ...
    selectedSourceTypes: LiquiditySourceType[]
    filterMode: FilterMode
    additionalData?: (Bytes | undefined)
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type KensetsuCall = KensetsuCall_accrue | KensetsuCall_borrow | KensetsuCall_close_cdp | KensetsuCall_create_cdp | KensetsuCall_deposit_collateral | KensetsuCall_donate | KensetsuCall_liquidate | KensetsuCall_repay_debt | KensetsuCall_update_borrow_tax | KensetsuCall_update_collateral_risk_parameters | KensetsuCall_update_liquidation_penalty | KensetsuCall_withdraw_profit
 ...
 */
export interface KensetsuCall_accrue {
    __kind: 'accrue'
    cdpId: bigint
}
 ...
 */
export interface KensetsuCall_borrow {
    __kind: 'borrow'
    cdpId: bigint
    borrowAmountMin: bigint
 ...
 */
export interface KensetsuCall_close_cdp {
    __kind: 'close_cdp'
    cdpId: bigint
}
 ...
 * - `borrow_amount_max`: The maximum amount the user wants to borrow.
 */
export interface KensetsuCall_create_cdp {
    __kind: 'create_cdp'
    collateralAssetId: AssetId32
    collateralAmount: bigint
    borrowAmountMin: bigint
 ...
 */
export interface KensetsuCall_deposit_collateral {
 ...
 */
export interface KensetsuCall_donate {
    __kind: 'donate'
    kusdAmount: bigint
}
 ...
 */
export interface KensetsuCall_liquidate {
    __kind: 'liquidate'
    cdpId: bigint
}
 ...
 */
export interface KensetsuCall_repay_debt {
    __kind: 'repay_debt'
    cdpId: bigint
    amount: bigint
}
 ...
 */
export interface KensetsuCall_update_borrow_tax {
    __kind: 'update_borrow_tax'
 ...
 */
export interface KensetsuCall_update_collateral_risk_parameters {
    __kind: 'update_collateral_risk_parameters'
    collateralAssetId: AssetId32
    newRiskParameters: CollateralRiskParameters
}
 ...
 */
export interface KensetsuCall_update_liquidation_penalty {
    __kind: 'update_liquidation_penalty'
 ...
 */
export interface KensetsuCall_withdraw_profit {
    __kind: 'withdraw_profit'
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type FarmingCall = FarmingCall_set_lp_min_xor_for_bonus_reward

export interface FarmingCall_set_lp_min_xor_for_bonus_reward {
    __kind: 'set_lp_min_xor_for_bonus_reward'
    newLpMinXorForBonusReward: bigint
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type EVMFungibleAppCall = EVMFungibleAppCall_burn | EVMFungibleAppCall_claim_relayer_fees | EVMFungibleAppCall_mint | EVMFungibleAppCall_register_asset_internal | EVMFungibleAppCall_register_existing_sidechain_asset | EVMFungibleAppCall_register_network | EVMFungibleAppCall_register_network_with_existing_asset | EVMFungibleAppCall_register_sidechain_asset | EVMFungibleAppCall_register_thischain_asset

export interface EVMFungibleAppCall_burn {
    __kind: 'burn'
    networkId: H256
    assetId: AssetId32
    recipient: H160
...
export interface EVMFungibleAppCall_claim_relayer_fees {
    __kind: 'claim_relayer_fees'
    networkId: H256
    relayer: H160
    signature: Signature
}

export interface EVMFungibleAppCall_mint {
    __kind: 'mint'
    token: H160
    sender: H160
    recipient: AccountId32
...
export interface EVMFungibleAppCall_register_asset_internal {
    __kind: 'register_asset_internal'
    assetId: AssetId32
    contract: H160
}

export interface EVMFungibleAppCall_register_existing_sidechain_asset {
    __kind: 'register_existing_sidechain_asset'
    networkId: H256
    address: H160
    assetId: AssetId32
...
export interface EVMFungibleAppCall_register_network {
...
export interface EVMFungibleAppCall_register_network_with_existing_asset {
...
export interface EVMFungibleAppCall_register_sidechain_asset {
    __kind: 'register_sidechain_asset'
    networkId: H256
    address: H160
    symbol: AssetSymbol
...
export interface EVMFungibleAppCall_register_thischain_asset {
    __kind: 'register_thischain_asset'
    networkId: H256
    assetId: AssetId32
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BridgeInboundChannelCall = BridgeInboundChannelCall_register_evm_channel | BridgeInboundChannelCall_submit

export interface BridgeInboundChannelCall_register_evm_channel {
    __kind: 'register_evm_channel'
    networkId: H256
    channelAddress: H160
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ApolloPlatformCall = ApolloPlatformCall_add_pool | ApolloPlatformCall_borrow | ApolloPlatformCall_change_rewards_amount | ApolloPlatformCall_change_rewards_per_block | ApolloPlatformCall_edit_pool_info | ApolloPlatformCall_get_rewards | ApolloPlatformCall_lend | ApolloPlatformCall_liquidate | ApolloPlatformCall_remove_pool | ApolloPlatformCall_repay | ApolloPlatformCall_withdraw

/**
 * Add pool
 */
export interface ApolloPlatformCall_add_pool {
    __kind: 'add_pool'
    assetId: AssetId32
    loanToValue: bigint
    liquidationThreshold: bigint
 ...
 * Borrow token
 */
export interface ApolloPlatformCall_borrow {
    __kind: 'borrow'
    collateralAsset: AssetId32
    borrowingAsset: AssetId32
    borrowingAmount: bigint
}
 ...
 */
export interface ApolloPlatformCall_change_rewards_amount {
    __kind: 'change_rewards_amount'
    isLending: boolean
    amount: bigint
}
 ...
 */
export interface ApolloPlatformCall_change_rewards_per_block {
    __kind: 'change_rewards_per_block'
    isLending: boolean
    amount: bigint
}
 ...
 * Edit pool info
 */
export interface ApolloPlatformCall_edit_pool_info {
    __kind: 'edit_pool_info'
    assetId: AssetId32
    newLoanToValue: bigint
    newLiquidationThreshold: bigint
    newOptimalUtilizationRate: bigint
    newBaseRate: bigint
    newSlopeRate1: bigint
    newSlopeRate2: bigint
 ...
 * Get rewards
 */
export interface ApolloPlatformCall_get_rewards {
    __kind: 'get_rewards'
    assetId: AssetId32
    isLending: boolean
}
 ...
 * Lend token
 */
export interface ApolloPlatformCall_lend {
    __kind: 'lend'
    lendingAsset: AssetId32
    lendingAmount: bigint
}
 ...
 * Liquidate
 */
export interface ApolloPlatformCall_liquidate {
    __kind: 'liquidate'
    user: AccountId32
    assetId: AssetId32
}
 ...
 * Remove pool
 */
export interface ApolloPlatformCall_remove_pool {
    __kind: 'remove_pool'
    assetIdToRemove: AssetId32
}

/**
 * Repay
 */
export interface ApolloPlatformCall_repay {
    __kind: 'repay'
    collateralAsset: AssetId32
    borrowingAsset: AssetId32
 ...
 * Withdraw
 */
export interface ApolloPlatformCall_withdraw {
    __kind: 'withdraw'
    withdrawnAsset: AssetId32
...
export interface Type_702 {
    amount: bigint
}

export const Type_702: sts.Type<Type_702> = sts.struct(() => {
    return  {
        amount: sts.bigint(),
    }
})

export interface Type_700 {
    free: bigint
    reserved: bigint
    frozen: bigint
}

export const Type_700: sts.Type<Type_700> = sts.struct(() => {
    return  {
        free: sts.bigint(),
        reserved: sts.bigint(),
        frozen: sts.bigint(),
...
export interface Type_698 {
    id: Bytes
    amount: bigint
}

export const Type_698: sts.Type<Type_698> = sts.struct(() => {
    return  {
        id: sts.bytes(),
        amount: sts.bigint(),
    }
...
export type PredefinedAssetId = PredefinedAssetId_DAI | PredefinedAssetId_DOT | PredefinedAssetId_ETH | PredefinedAssetId_KEN | PredefinedAssetId_KSM | PredefinedAssetId_KUSD | PredefinedAssetId_PSWAP | PredefinedAssetId_TBCD | PredefinedAssetId_USDT | PredefinedAssetId_VAL | PredefinedAssetId_XOR | PredefinedAssetId_XST | PredefinedAssetId_XSTUSD
...
export interface PredefinedAssetId_KEN {
    __kind: 'KEN'
}
...
export interface PredefinedAssetId_KUSD {
    __kind: 'KUSD'
}
...
export type Type_224 = Type_224_ApplyExtrinsic | Type_224_Finalization | Type_224_Initialization

export interface Type_224_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_224_Finalization {
    __kind: 'Finalization'
}

export interface Type_224_Initialization {
...
export type Event = Event_ApolloPlatform | Event_Assets | Event_BagsList | Event_Balances | Event_Band | Event_BeefyLightClient | Event_BridgeDataSigner | Event_BridgeInboundChannel | Event_BridgeMultisig | Event_BridgeOutboundChannel | Event_BridgeProxy | Event_CeresGovernancePlatform | Event_CeresLaunchpad | Event_CeresLiquidityLocker | Event_CeresStaking | Event_CeresTokenLocker | Event_Council | Event_DEXAPI | Event_DemeterFarmingPlatform | Event_Democracy | Event_Dispatch | Event_EVMFungibleApp | Event_ElectionProviderMultiPhase | Event_ElectionsPhragmen | Event_EthBridge | Event_Farming | Event_Faucet | Event_Grandpa | Event_HermesGovernancePlatform | Event_Identity | Event_ImOnline | Event_IrohaMigration | Event_Kensetsu | Event_LeafProvider | Event_LiquidityProxy | Event_MulticollateralBondingCurvePool | Event_Multisig | Event_MultisigVerifier | Event_Offences | Event_OracleProxy | Event_OrderBook | Event_ParachainBridgeApp | Event_Permissions | Event_PoolXYK | Event_Preimage | Event_PriceTools | Event_PswapDistribution | Event_QaTools | Event_Rewards | Event_Scheduler | Event_Session | Event_Staking | Event_SubstrateBridgeApp | Event_SubstrateBridgeInboundChannel | Event_SubstrateBridgeOutboundChannel | Event_SubstrateDispatch | Event_Sudo | Event_System | Event_Technical | Event_TechnicalCommittee | Event_TechnicalMembership | Event_Tokens | Event_TradingPair | Event_TransactionPayment | Event_Utility | Event_VestedRewards | Event_XSTPool | Event_XorFee

export interface Event_ApolloPlatform {
    __kind: 'ApolloPlatform'
    value: ApolloPlatformEvent
}
...
export interface Event_EVMFungibleApp {
    __kind: 'EVMFungibleApp'
    value: EVMFungibleAppEvent
}
...
export interface Event_Kensetsu {
    __kind: 'Kensetsu'
    value: KensetsuEvent
}
...
export interface Event_QaTools {
    __kind: 'QaTools'
    value: QaToolsEvent
}
 ...
 */
export type SubstrateBridgeOutboundChannelEvent = SubstrateBridgeOutboundChannelEvent_IntervalUpdated | SubstrateBridgeOutboundChannelEvent_MessageAccepted

export interface SubstrateBridgeOutboundChannelEvent_IntervalUpdated {
    __kind: 'IntervalUpdated'
    interval: number
}
 ...
 */
export type SubstrateBridgeAppEvent = SubstrateBridgeAppEvent_AssetRegistrationFinalized | SubstrateBridgeAppEvent_AssetRegistrationProceed | SubstrateBridgeAppEvent_Burned | SubstrateBridgeAppEvent_FailedToMint | SubstrateBridgeAppEvent_Minted

export interface SubstrateBridgeAppEvent_AssetRegistrationFinalized {
    __kind: 'AssetRegistrationFinalized'
    value: AssetId32
}

export interface SubstrateBridgeAppEvent_AssetRegistrationProceed {
    __kind: 'AssetRegistrationProceed'
    value: AssetId32
}
...
export interface SubstrateBridgeAppEvent_FailedToMint {
    __kind: 'FailedToMint'
 ...
 */
export type QaToolsEvent = QaToolsEvent_McbcInitialized | QaToolsEvent_OrderBooksCreated | QaToolsEvent_OrderBooksFilled | QaToolsEvent_XstInitialized | QaToolsEvent_XykInitialized

/**
 * Multicollateral bonding curve liquidity source has been initialized successfully.
 */
export interface QaToolsEvent_McbcInitialized {
    __kind: 'McbcInitialized'
    /**
     * Exact reference prices achieved for the collateral assets.
     */
    collateralRefPrices: [AssetId32, AssetPrices][]
}

/**
 * Requested order books have been created.
 */
export interface QaToolsEvent_OrderBooksCreated {
    __kind: 'OrderBooksCreated'
}

/**
 * Requested order book have been filled.
 */
export interface QaToolsEvent_OrderBooksFilled {
    __kind: 'OrderBooksFilled'
}

/**
 * XST liquidity source has been initialized successfully.
 */
export interface QaToolsEvent_XstInitialized {
    __kind: 'XstInitialized'
    /**
     ...
     */
    quotesAchieved: SyntheticOutput[]
}

/**
 * Xyk liquidity source has been initialized successfully.
 */
export interface QaToolsEvent_XykInitialized {
    __kind: 'XykInitialized'
    /**
     * Exact prices for token pairs achievable after the initialization.
     * Should correspond 1-to-1 to the initialization input and be quite close to the given values.
     */
    pricesAchieved: AssetPairInput[]
}

export interface SyntheticOutput {
    assetId: AssetId32
    quoteAchieved: SyntheticQuote
}
 ...
 */
export type MulticollateralBondingCurvePoolEvent = MulticollateralBondingCurvePoolEvent_FailedToDistributeFreeReserves | MulticollateralBondingCurvePoolEvent_OptionalRewardMultiplierUpdated | MulticollateralBondingCurvePoolEvent_PoolInitialized | MulticollateralBondingCurvePoolEvent_PriceBiasChanged | MulticollateralBondingCurvePoolEvent_PriceChangeConfigChanged | MulticollateralBondingCurvePoolEvent_ReferenceAssetChanged

/**
 * Free reserves distribution routine failed. [Error]
 */
export interface MulticollateralBondingCurvePoolEvent_FailedToDistributeFreeReserves {
    __kind: 'FailedToDistributeFreeReserves'
    value: DispatchError
}
...
export interface LiquidityProxyEvent_BatchSwapExecuted {
    ...
    value: [bigint, bigint, (BoundedVec | undefined)]
}
...
export interface LiquidityProxyEvent_Exchange {
    __kind: 'Exchange'
    value: [AccountId32, number, AssetId32, AssetId32, bigint, bigint, [AssetId32, bigint][], LiquiditySourceId[]]
}
...
export interface LiquidityProxyEvent_XorlessTransfer {
    ...
    value: [AssetId32, AccountId32, AccountId32, bigint, (Bytes | undefined)]
}
 ...
 */
export type KensetsuEvent = KensetsuEvent_BorrowTaxUpdated | KensetsuEvent_CDPClosed | KensetsuEvent_CDPCreated | KensetsuEvent_CollateralDeposit | KensetsuEvent_CollateralRiskParametersUpdated | KensetsuEvent_DebtIncreased | KensetsuEvent_DebtPayment | KensetsuEvent_Donation | KensetsuEvent_Liquidated | KensetsuEvent_LiquidationPenaltyUpdated | KensetsuEvent_ProfitWithdrawn

export interface KensetsuEvent_BorrowTaxUpdated {
    __kind: 'BorrowTaxUpdated'
    oldBorrowTax: Percent
    newBorrowTax: Percent
}

export interface KensetsuEvent_CDPClosed {
    __kind: 'CDPClosed'
    cdpId: bigint
    owner: AccountId32
    collateralAssetId: AssetId32
...
export interface KensetsuEvent_CDPCreated {
    __kind: 'CDPCreated'
    cdpId: bigint
    owner: AccountId32
    collateralAssetId: AssetId32
    debtAssetId: AssetId32
    cdpType: CdpType
}

export interface KensetsuEvent_CollateralDeposit {
    __kind: 'CollateralDeposit'
    cdpId: bigint
    owner: AccountId32
    collateralAssetId: AssetId32
    amount: bigint
...
export interface KensetsuEvent_CollateralRiskParametersUpdated {
    __kind: 'CollateralRiskParametersUpdated'
    collateralAssetId: AssetId32
    riskParameters: CollateralRiskParameters
}

export interface KensetsuEvent_DebtIncreased {
    __kind: 'DebtIncreased'
    cdpId: bigint
    owner: AccountId32
    debtAssetId: AssetId32
    /**
...
export interface KensetsuEvent_DebtPayment {
    __kind: 'DebtPayment'
    cdpId: bigint
    owner: AccountId32
    debtAssetId: AssetId32
...
export interface KensetsuEvent_Donation {
    __kind: 'Donation'
    debtAssetId: AssetId32
    amount: bigint
}

export interface KensetsuEvent_Liquidated {
    __kind: 'Liquidated'
    cdpId: bigint
    collateralAssetId: AssetId32
    collateralAmount: bigint
...
export interface KensetsuEvent_LiquidationPenaltyUpdated {
    __kind: 'LiquidationPenaltyUpdated'
    newLiquidationPenalty: Percent
    oldLiquidationPenalty: Percent
}

export interface KensetsuEvent_ProfitWithdrawn {
    __kind: 'ProfitWithdrawn'
    debtAssetId: AssetId32
    amount: bigint
}

export type CdpType = CdpType_Type1 | CdpType_Type2

export interface CdpType_Type1 {
    __kind: 'Type1'
}

export interface CdpType_Type2 {
    __kind: 'Type2'
}
 ...
 */
export type FarmingEvent = FarmingEvent_LpMinXorForBonusRewardUpdated

/**
 * When Minimum XOR amount for Liquidity Provider Bonus Reward is updated
 */
export interface FarmingEvent_LpMinXorForBonusRewardUpdated {
    __kind: 'LpMinXorForBonusRewardUpdated'
    newLpMinXorForBonusReward: bigint
    oldLpMinXorForBonusReward: bigint
}
 ...
 */
export type EVMFungibleAppEvent = EVMFungibleAppEvent_AssetRegistered | EVMFungibleAppEvent_Burned | EVMFungibleAppEvent_FeesClaimed | EVMFungibleAppEvent_Minted | EVMFungibleAppEvent_Refunded

/**
 * New asset registered.
 */
export interface EVMFungibleAppEvent_AssetRegistered {
 ...
 */
export interface EVMFungibleAppEvent_Burned {
    __kind: 'Burned'
    networkId: H256
    assetId: AssetId32
    sender: AccountId32
 ...
 */
export interface EVMFungibleAppEvent_FeesClaimed {
    __kind: 'FeesClaimed'
    recipient: AccountId32
    assetId: AssetId32
    amount: bigint
 ...
 */
export interface EVMFungibleAppEvent_Minted {
    __kind: 'Minted'
    networkId: H256
    assetId: AssetId32
    sender: H160
 ...
 */
export interface EVMFungibleAppEvent_Refunded {
    __kind: 'Refunded'
    networkId: H256
    recipient: AccountId32
    assetId: AssetId32
 ...
 */
export type ApolloPlatformEvent = ApolloPlatformEvent_Borrowed | ApolloPlatformEvent_ChangedRewardsAmount | ApolloPlatformEvent_ChangedRewardsAmountPerBlock | ApolloPlatformEvent_ClaimedBorrowingRewards | ApolloPlatformEvent_ClaimedLendingRewards | ApolloPlatformEvent_Lent | ApolloPlatformEvent_Liquidated | ApolloPlatformEvent_PoolAdded | ApolloPlatformEvent_PoolInfoEdited | ApolloPlatformEvent_PoolRemoved | ApolloPlatformEvent_Repaid | ApolloPlatformEvent_Withdrawn

/**
 * Borrowed [who, collateral_asset, collateral_amount, borrow_asset, borrow_amount]
 */
export interface ApolloPlatformEvent_Borrowed {
    __kind: 'Borrowed'
    value: [AccountId32, AssetId32, bigint, AssetId32, bigint]
}

export interface ApolloPlatformEvent_ChangedRewardsAmount {
    __kind: 'ChangedRewardsAmount'
    value: [AccountId32, boolean, bigint]
}

export interface ApolloPlatformEvent_ChangedRewardsAmountPerBlock {
    __kind: 'ChangedRewardsAmountPerBlock'
    value: [AccountId32, boolean, bigint]
}
 ...
 */
export interface ApolloPlatformEvent_ClaimedBorrowingRewards {
    __kind: 'ClaimedBorrowingRewards'
    value: [AccountId32, AssetId32, bigint]
}
 ...
 */
export interface ApolloPlatformEvent_ClaimedLendingRewards {
    __kind: 'ClaimedLendingRewards'
    value: [AccountId32, AssetId32, bigint]
}
 ...
 */
export interface ApolloPlatformEvent_Lent {
    __kind: 'Lent'
    value: [AccountId32, AssetId32, bigint]
}
 ...
 */
export interface ApolloPlatformEvent_Liquidated {
    __kind: 'Liquidated'
    value: [AccountId32, AssetId32]
}
 ...
 */
export interface ApolloPlatformEvent_PoolAdded {
    __kind: 'PoolAdded'
    value: [AccountId32, AssetId32]
}
 ...
 */
export interface ApolloPlatformEvent_PoolInfoEdited {
    __kind: 'PoolInfoEdited'
    value: [AccountId32, AssetId32]
}
 ...
 */
export interface ApolloPlatformEvent_PoolRemoved {
    __kind: 'PoolRemoved'
    value: [AccountId32, AssetId32]
}
 ...
 */
export interface ApolloPlatformEvent_Repaid {
    __kind: 'Repaid'
    value: [AccountId32, AssetId32, bigint]
}
 ...
 */
export interface ApolloPlatformEvent_Withdrawn {
    __kind: 'Withdrawn'
    value: [AccountId32, AssetId32, bigint]
}
...
export const Event: sts.Type<Event> = sts.closedEnum(() => {
    return  {
        ApolloPlatform: ApolloPlatformEvent,
        Assets: AssetsEvent,
        ...
        EVMFungibleApp: EVMFungibleAppEvent,
...
export const SubstrateBridgeOutboundChannelEvent: sts.Type<SubstrateBridgeOutboundChannelEvent> = sts.closedEnum(() => {
    return  {
        IntervalUpdated: sts.enumStruct({
            interval: sts.number(),
        }),
...
export const SubstrateBridgeAppEvent: sts.Type<SubstrateBridgeAppEvent> = sts.closedEnum(() => {
    return  {
        AssetRegistrationFinalized: AssetId32,
        AssetRegistrationProceed: AssetId32,
        ...
        FailedToMint: sts.tuple(() => [H256, DispatchError]),
 ...
 */
export const QaToolsEvent: sts.Type<QaToolsEvent> = sts.closedEnum(() => {
    return  {
        McbcInitialized: sts.enumStruct({
            collateralRefPrices: sts.array(() => sts.tuple(() => [AssetId32, AssetPrices])),
        }),
        OrderBooksCreated: sts.unit(),
        OrderBooksFilled: sts.unit(),
        XstInitialized: sts.enumStruct({
            quotesAchieved: sts.array(() => SyntheticOutput),
        }),
        XykInitialized: sts.enumStruct({
            pricesAchieved: sts.array(() => AssetPairInput),
        }),
    }
})
...
export const LiquidityProxyEvent: sts.Type<LiquidityProxyEvent> = sts.closedEnum(() => {
    return  {
        ...
        BatchSwapExecuted: sts.tuple(() => [sts.bigint(), sts.bigint(), sts.option(() => BoundedVec)]),
        Exchange: sts.tuple(() => [AccountId32, sts.number(), AssetId32, AssetId32, sts.bigint(), sts.bigint(), sts.array(() => sts.tuple(() => [AssetId32, sts.bigint()])), sts.array(() => LiquiditySourceId)]),
        LiquiditySourceDisabled: LiquiditySourceType,
        LiquiditySourceEnabled: LiquiditySourceType,
        XorlessTransfer: sts.tuple(() => [AssetId32, AccountId32, AccountId32, sts.bigint(), sts.option(() => sts.bytes())]),
    }
})
 ...
 */
export const KensetsuEvent: sts.Type<KensetsuEvent> = sts.closedEnum(() => {
    return  {
        BorrowTaxUpdated: sts.enumStruct({
            oldBorrowTax: Percent,
            newBorrowTax: Percent,
        }),
        CDPClosed: sts.enumStruct({
            cdpId: sts.bigint(),
            owner: AccountId32,
            collateralAssetId: AssetId32,
            collateralAmount: sts.bigint(),
        }),
        CDPCreated: sts.enumStruct({
            cdpId: sts.bigint(),
            owner: AccountId32,
            collateralAssetId: AssetId32,
            debtAssetId: AssetId32,
        ...
        CollateralDeposit: sts.enumStruct({
            cdpId: sts.bigint(),
            owner: AccountId32,
            collateralAssetId: AssetId32,
            amount: sts.bigint(),
        }),
        CollateralRiskParametersUpdated: sts.enumStruct({
            collateralAssetId: AssetId32,
            riskParameters: CollateralRiskParameters,
        }),
        DebtIncreased: sts.enumStruct({
            cdpId: sts.bigint(),
            owner: AccountId32,
            debtAssetId: AssetId32,
            amount: sts.bigint(),
        }),
        DebtPayment: sts.enumStruct({
            cdpId: sts.bigint(),
            owner: AccountId32,
            debtAssetId: AssetId32,
            amount: sts.bigint(),
        }),
        Donation: sts.enumStruct({
            debtAssetId: AssetId32,
            amount: sts.bigint(),
        }),
        ...
        LiquidationPenaltyUpdated: sts.enumStruct({
            newLiquidationPenalty: Percent,
            oldLiquidationPenalty: Percent,
        }),
        ProfitWithdrawn: sts.enumStruct({
            debtAssetId: AssetId32,
            amount: sts.bigint(),
        }),
    }
 ...
 */
export const FarmingEvent: sts.Type<FarmingEvent> = sts.closedEnum(() => {
    return  {
        LpMinXorForBonusRewardUpdated: sts.enumStruct({
 ...
 */
export const EVMFungibleAppEvent: sts.Type<EVMFungibleAppEvent> = sts.closedEnum(() => {
    return  {
        AssetRegistered: sts.enumStruct({
            networkId: H256,
            assetId: AssetId32,
        }),
        Burned: sts.enumStruct({
 ...
 */
export const ApolloPlatformEvent: sts.Type<ApolloPlatformEvent> = sts.closedEnum(() => {
    return  {
        Borrowed: sts.tuple(() => [AccountId32, AssetId32, sts.bigint(), AssetId32, sts.bigint()]),
        ChangedRewardsAmount: sts.tuple(() => [AccountId32, sts.boolean(), sts.bigint()]),
        ChangedRewardsAmountPerBlock: sts.tuple(() => [AccountId32, sts.boolean(), sts.bigint()]),
        ClaimedBorrowingRewards: sts.tuple(() => [AccountId32, AssetId32, sts.bigint()]),
        ClaimedLendingRewards: sts.tuple(() => [AccountId32, AssetId32, sts.bigint()]),
        Lent: sts.tuple(() => [AccountId32, AssetId32, sts.bigint()]),
        Liquidated: sts.tuple(() => [AccountId32, AssetId32]),
        PoolAdded: sts.tuple(() => [AccountId32, AssetId32]),
        PoolInfoEdited: sts.tuple(() => [AccountId32, AssetId32]),
        PoolRemoved: sts.tuple(() => [AccountId32, AssetId32]),
        Repaid: sts.tuple(() => [AccountId32, AssetId32, sts.bigint()]),
        Withdrawn: sts.tuple(() => [AccountId32, AssetId32, sts.bigint()]),
    }
})
...
export const InputAssetId: sts.Type<InputAssetId> = sts.closedEnum(() => {
    return  {
        McbcReference: sts.unit(),
        Other: AssetId32,
        XstReference: sts.unit(),
    }
})

export const TbcdCollateralInput: sts.Type<TbcdCollateralInput> = sts.struct(() => {
    return  {
        parameters: CollateralCommonParameters,
        refXorPrices: sts.option(() => AssetPrices),
    }
})

export const CollateralCommonParameters: sts.Type<CollateralCommonParameters> = sts.struct(() => {
    return  {
        refPrices: sts.option(() => AssetPrices),
        reserves: sts.option(() => sts.bigint()),
    }
})

export const OtherCollateralInput: sts.Type<OtherCollateralInput> = sts.struct(() => {
    return  {
        asset: AssetId32,
        parameters: CollateralCommonParameters,
    }
...
export const BaseSupply: sts.Type<BaseSupply> = sts.struct(() => {
    return  {
        assetCollector: AccountId32,
        target: sts.bigint(),
    }
...
export const SyntheticInput: sts.Type<SyntheticInput> = sts.struct(() => {
    return  {
        assetId: AssetId32,
        expectedQuote: SyntheticQuote,
        existence: SyntheticExistence,
...
export const SyntheticExistence: sts.Type<SyntheticExistence> = sts.closedEnum(() => {
    return  {
        AlreadyExists: sts.unit(),
        RegisterNewAsset: sts.enumStruct({
            symbol: AssetSymbol,
            name: AssetName,
            referenceSymbol: SymbolName,
            feeRatio: FixedPoint,
...
export const SyntheticQuote: sts.Type<SyntheticQuote> = sts.struct(() => {
    return  {
        direction: SyntheticQuoteDirection,
        amount: QuoteAmount,
        result: sts.bigint(),
...
export const QuoteAmount: sts.Type<QuoteAmount> = sts.closedEnum(() => {
    return  {
...
export const SyntheticQuoteDirection: sts.Type<SyntheticQuoteDirection> = sts.closedEnum(() => {
    return  {
        SyntheticBaseToSynthetic: sts.unit(),
        SyntheticToSyntheticBase: sts.unit(),
    }
})

export const BaseInput: sts.Type<BaseInput> = sts.struct(() => {
    return  {
        referencePerSyntheticBaseBuy: sts.bigint(),
        referencePerSyntheticBaseSell: sts.bigint(),
    }
})

export const FillInput: sts.Type<FillInput> = sts.struct(() => {
    return  {
        asks: sts.option(() => SideFillInput),
        bids: sts.option(() => SideFillInput),
        randomSeed: sts.option(() => sts.number()),
    }
})

export const SideFillInput: sts.Type<SideFillInput> = sts.struct(() => {
    return  {
...
export const GenericAssetId: sts.Type<GenericAssetId> = sts.closedEnum(() => {
    return  {
        EVM: H160,
...
export const LiberlandAssetId: sts.Type<LiberlandAssetId> = sts.closedEnum(() => {
    return  {
        Asset: sts.number(),
        LLD: sts.unit(),
    }
...
export const GenericBalance: sts.Type<GenericBalance> = sts.closedEnum(() => {
    return  {
        EVM: H256,
        Substrate: sts.bigint(),
    }
})
...
export const Type_615: sts.Type<Type_615> = sts.closedEnum(() => {
    return  {
        Sidechain: sts.unit(),
        Thischain: sts.unit(),
    }
...
export const Type_603: sts.Type<Type_603> = sts.struct(() => {
    return  {
...
export const MultiProof: sts.Type<MultiProof> = sts.closedEnum(() => {
    return  {
        ...
        EVMMultisig: MultiEVMProof,
        Multisig: Type_599,
    }
})

export const Type_599: sts.Type<Type_599> = sts.struct(() => {
    return  {
        digest: AuxiliaryDigest,
...
export const MultiEVMProof: sts.Type<MultiEVMProof> = sts.struct(() => {
    return  {
        proof: sts.array(() => Signature),
    }
})
...
export const Type_576: sts.Type<Type_576> = sts.closedEnum(() => {
    return  {
        ...
        Outbound: OutboundCommitment,
        StatusReport: StatusReport,
    }
})

export const StatusReport: sts.Type<StatusReport> = sts.struct(() => {
    return  {
        channel: H160,
        blockNumber: sts.bigint(),
        relayer: H160,
        nonce: sts.bigint(),
        results: sts.array(() => sts.boolean()),
        gasSpent: sts.bigint(),
        baseFee: sts.bigint(),
    }
})

export const OutboundCommitment: sts.Type<OutboundCommitment> = sts.struct(() => {
    return  {
        nonce: sts.bigint(),
...
export const InboundCommitment: sts.Type<InboundCommitment> = sts.struct(() => {
    return  {
        channel: H160,
        source: H160,
        nonce: sts.bigint(),
...
export const BaseFeeUpdate: sts.Type<BaseFeeUpdate> = sts.struct(() => {
    return  {
        newBaseFee: sts.bigint(),
        evmBlockNumber: sts.bigint(),
    }
})
...
export const Type_312: sts.Type<Type_312> = sts.struct(() => {
    return  {
        origin: Type_313,
    }
})
...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ApolloPlatform: ApolloPlatformCall,
        Assets: AssetsCall,
        Babe: BabeCall,
        ...
        EVMFungibleApp: EVMFungibleAppCall,
        ...
        SubstrateBridgeOutboundChannel: SubstrateBridgeOutboundChannelCall,
        Sudo: SudoCall,
        System: SystemCall,
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const SubstrateBridgeOutboundChannelCall: sts.Type<SubstrateBridgeOutboundChannelCall> = sts.closedEnum(() => {
    return  {
        update_interval: sts.enumStruct({
...
export const SubstrateBridgeAppCall: sts.Type<SubstrateBridgeAppCall> = sts.closedEnum(() => {
    return  {
        ...
        incoming_thischain_asset_registration: sts.enumStruct({
            assetId: AssetId32,
            sidechainAssetId: GenericAssetId,
        }),
        mint: sts.enumStruct({
...
export const QaToolsCall: sts.Type<QaToolsCall> = sts.closedEnum(() => {
    return  {
        mcbc_initialize: sts.enumStruct({
            baseSupply: sts.option(() => BaseSupply),
            otherCollaterals: sts.array(() => OtherCollateralInput),
            tbcdCollateral: sts.option(() => TbcdCollateralInput),
        }),
        order_book_create_and_fill_batch: sts.enumStruct({
            bidsOwner: AccountId32,
            asksOwner: AccountId32,
            settings: sts.array(() => sts.tuple(() => [OrderBookId, OrderBookAttributes, FillInput])),
        }),
        order_book_fill_batch: sts.enumStruct({
            bidsOwner: AccountId32,
            asksOwner: AccountId32,
            settings: sts.array(() => sts.tuple(() => [OrderBookId, FillInput])),
        }),
        price_tools_set_asset_price: sts.enumStruct({
            assetPerXor: AssetPrices,
            assetId: InputAssetId,
        }),
        xst_initialize: sts.enumStruct({
            basePrices: sts.option(() => BaseInput),
            syntheticsPrices: sts.array(() => SyntheticInput),
            relayer: AccountId32,
        }),
        xyk_initialize: sts.enumStruct({
            account: AccountId32,
            pairs: sts.array(() => AssetPairInput),
        }),
    }
})
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const KensetsuCall: sts.Type<KensetsuCall> = sts.closedEnum(() => {
    return  {
        accrue: sts.enumStruct({
            cdpId: sts.bigint(),
        }),
        ...
        close_cdp: sts.enumStruct({
            cdpId: sts.bigint(),
        }),
        create_cdp: sts.enumStruct({
            collateralAssetId: AssetId32,
            collateralAmount: sts.bigint(),
            borrowAmountMin: sts.bigint(),
            borrowAmountMax: sts.bigint(),
        ...
        donate: sts.enumStruct({
            kusdAmount: sts.bigint(),
        }),
        liquidate: sts.enumStruct({
            cdpId: sts.bigint(),
        }),
        repay_debt: sts.enumStruct({
            cdpId: sts.bigint(),
            amount: sts.bigint(),
        }),
        update_borrow_tax: sts.enumStruct({
            newBorrowTax: Percent,
        }),
        update_collateral_risk_parameters: sts.enumStruct({
            collateralAssetId: AssetId32,
            newRiskParameters: CollateralRiskParameters,
        }),
        update_liquidation_penalty: sts.enumStruct({
            newLiquidationPenalty: Percent,
        }),
        withdraw_profit: sts.enumStruct({
            beneficiary: AccountId32,
            kusdAmount: sts.bigint(),
        }),
    }
...
export const FarmingCall: sts.Type<FarmingCall> = sts.closedEnum(() => {
    return  {
        set_lp_min_xor_for_bonus_reward: sts.enumStruct({
            newLpMinXorForBonusReward: sts.bigint(),
        }),
    }
})
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const EVMFungibleAppCall: sts.Type<EVMFungibleAppCall> = sts.closedEnum(() => {
    return  {
        burn: sts.enumStruct({
            networkId: H256,
            assetId: AssetId32,
        ...
        claim_relayer_fees: sts.enumStruct({
            networkId: H256,
            relayer: H160,
            signature: Signature,
        }),
...
export const BridgeInboundChannelCall: sts.Type<BridgeInboundChannelCall> = sts.closedEnum(() => {
    return  {
        register_evm_channel: sts.enumStruct({
            networkId: H256,
            channelAddress: H160,
        }),
        submit: sts.enumStruct({
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const ApolloPlatformCall: sts.Type<ApolloPlatformCall> = sts.closedEnum(() => {
    return  {
        add_pool: sts.enumStruct({
            assetId: AssetId32,
            loanToValue: sts.bigint(),
        ...
        change_rewards_amount: sts.enumStruct({
            isLending: sts.boolean(),
            amount: sts.bigint(),
        }),
        change_rewards_per_block: sts.enumStruct({
            isLending: sts.boolean(),
            amount: sts.bigint(),
        }),
        edit_pool_info: sts.enumStruct({
            assetId: AssetId32,
...
export const AssetPrices: sts.Type<AssetPrices> = sts.struct(() => {
    return  {
        buy: sts.bigint(),
        sell: sts.bigint(),
    }
...
export const SyntheticOutput: sts.Type<SyntheticOutput> = sts.struct(() => {
    return  {
        assetId: AssetId32,
        quoteAchieved: SyntheticQuote,
    }
...
export const AssetPairInput: sts.Type<AssetPairInput> = sts.struct(() => {
    return  {
        dexId: sts.number(),
        assetA: AssetId32,
        assetB: AssetId32,
        price: sts.bigint(),
        maybeAssetAReserves: sts.option(() => sts.bigint()),
    }
})
...
export const CollateralRiskParameters: sts.Type<CollateralRiskParameters> = sts.struct(() => {
    return  {
        hardCap: sts.bigint(),
        liquidationRatio: Perbill,
        maxLiquidationLot: sts.bigint(),
        stabilityFeeRate: FixedU128,
        minimalCollateralDeposit: sts.bigint(),
    }
})

export const CdpType: sts.Type<CdpType> = sts.closedEnum(() => {
    return  {
        Type1: sts.unit(),
        Type2: sts.unit(),
    }
