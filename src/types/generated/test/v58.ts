...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_290
    maxValidatorCount: Type_290
    chillThreshold: Type_291
    minCommission: Type_292
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type XSTPoolCall = XSTPoolCall_set_reference_asset | XSTPoolCall_enable_synthetic_asset | XSTPoolCall_register_synthetic_asset | XSTPoolCall_disable_synthetic_asset | XSTPoolCall_set_synthetic_asset_fee | XSTPoolCall_set_synthetic_base_asset_floor_price
...
export type Type_594 = Type_594_Thischain | Type_594_Sidechain
 ...
 */
export type XSTPoolEvent = XSTPoolEvent_ReferenceAssetChanged | XSTPoolEvent_SyntheticAssetEnabled | XSTPoolEvent_SyntheticAssetDisabled | XSTPoolEvent_SyntheticAssetFeeChanged | XSTPoolEvent_SyntheticBaseAssetFloorPriceChanged
