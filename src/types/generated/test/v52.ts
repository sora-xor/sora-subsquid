...
export type Type_572 = Type_572_Thischain | Type_572_Sidechain
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_274
    maxValidatorCount: Type_274
    chillThreshold: Type_275
    minCommission: Type_276
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type OrderBookCall = OrderBookCall_create_orderbook | OrderBookCall_delete_orderbook | OrderBookCall_update_orderbook | OrderBookCall_change_orderbook_status | OrderBookCall_place_limit_order | OrderBookCall_cancel_limit_order
 ...
 */
export type OrderBookEvent = OrderBookEvent_OrderBookCreated | OrderBookEvent_OrderBookDeleted | OrderBookEvent_OrderBookUpdated | OrderBookEvent_OrderPlaced | OrderBookEvent_OrderCanceled
 ...
 */
export interface OrderBookEvent_OrderPlaced {
    __kind: 'OrderPlaced'
    orderBookId: TradingPair
    dexId: number
    orderId: bigint
 ...
 */
export interface OrderBookEvent_OrderCanceled {
    __kind: 'OrderCanceled'
    orderBookId: TradingPair
    dexId: number
    orderId: bigint
    ownerId: Uint8Array
