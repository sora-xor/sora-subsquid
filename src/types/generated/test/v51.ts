...
export type Type_687 = Type_687_Unrequested | Type_687_Requested

export interface Type_687_Unrequested {
    __kind: 'Unrequested'
    deposit: [Uint8Array, bigint]
    len: number
}

export interface Type_687_Requested {
    __kind: 'Requested'
