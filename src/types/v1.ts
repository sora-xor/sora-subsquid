...
export type Type_50 = Type_50_System | Type_50_Timestamp | Type_50_Balances | Type_50_RandomnessCollectiveFlip | Type_50_Permissions | Type_50_ReferralSystem | Type_50_Rewards | Type_50_XorFee | Type_50_BridgeMultisig | Type_50_Utility | Type_50_Session | Type_50_Babe | Type_50_Grandpa | Type_50_Authorship | Type_50_Staking | Type_50_Currencies | Type_50_TradingPair | Type_50_Assets | Type_50_MulticollateralBondingCurvePool | Type_50_PoolXYK | Type_50_LiquidityProxy | Type_50_Council | Type_50_TechnicalCommittee | Type_50_Democracy | Type_50_EthBridge | Type_50_PswapDistribution | Type_50_Multisig | Type_50_Scheduler | Type_50_IrohaMigration | Type_50_ImOnline | Type_50_Offences | Type_50_TechnicalMembership | Type_50_ElectionsPhragmen | Type_50_VestedRewards
...
export type Proposal = Proposal_System | Proposal_Timestamp | Proposal_Balances | Proposal_RandomnessCollectiveFlip | Proposal_Permissions | Proposal_ReferralSystem | Proposal_Rewards | Proposal_XorFee | Proposal_BridgeMultisig | Proposal_Utility | Proposal_Session | Proposal_Babe | Proposal_Grandpa | Proposal_Authorship | Proposal_Staking | Proposal_Currencies | Proposal_TradingPair | Proposal_Assets | Proposal_MulticollateralBondingCurvePool | Proposal_PoolXYK | Proposal_LiquidityProxy | Proposal_Council | Proposal_TechnicalCommittee | Proposal_Democracy | Proposal_EthBridge | Proposal_PswapDistribution | Proposal_Multisig | Proposal_Scheduler | Proposal_IrohaMigration | Proposal_ImOnline | Proposal_Offences | Proposal_TechnicalMembership | Proposal_ElectionsPhragmen | Proposal_VestedRewards
...
export type RequestStatus = RequestStatus_Pending | RequestStatus_Frozen | RequestStatus_ApprovalsReady | RequestStatus_Failed | RequestStatus_Done
...
export type Mode = Mode_Permit | Mode_Forbid
...
export type MulticollateralBondingCurvePoolCall = MulticollateralBondingCurvePoolCall_initialize_pool | MulticollateralBondingCurvePoolCall_set_reference_asset | MulticollateralBondingCurvePoolCall_set_optional_reward_multiplier | MulticollateralBondingCurvePoolCall_claim_incentives
...
export type PoolXYKCall = PoolXYKCall_swap_pair | PoolXYKCall_deposit_liquidity | PoolXYKCall_withdraw_liquidity | PoolXYKCall_initialize_pool
...
export type EthBridgeCall = EthBridgeCall_register_bridge | EthBridgeCall_add_asset | EthBridgeCall_add_sidechain_token | EthBridgeCall_transfer_to_sidechain | EthBridgeCall_request_from_sidechain | EthBridgeCall_finalize_incoming_request | EthBridgeCall_add_peer | EthBridgeCall_remove_peer | EthBridgeCall_prepare_for_migration | EthBridgeCall_migrate | EthBridgeCall_register_incoming_request | EthBridgeCall_import_incoming_request | EthBridgeCall_approve_request | EthBridgeCall_abort_request | EthBridgeCall_force_add_peer
...
export type EthBridgeEvent = EthBridgeEvent_RequestRegistered | EthBridgeEvent_ApprovalsCollected | EthBridgeEvent_RequestFinalizationFailed | EthBridgeEvent_IncomingRequestFinalizationFailed | EthBridgeEvent_IncomingRequestFinalized | EthBridgeEvent_RequestAborted
