...
export async function poolXykDepositLiquidityCallHandler(ctx: BlockContext, call: Call<'PoolXYK.deposit_liquidity'>): Promise<void> {
	...
	const transfers = findEventsByExtrinsicHash(ctx, call.extrinsic.hash, ['Balances.Transfer', 'Tokens.Transfer', 'Currencies.Transferred'])
