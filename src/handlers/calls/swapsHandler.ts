...
const handleAndSaveExtrinsic = async (ctx: Context, block: Block, call: CallEntity): Promise<void> => {
...
export async function handleSwaps(ctx: Context, block: Block, call: CallEntity): Promise<void> {

    if (call.kind !== 'call' || call.name !== 'LiquidityProxy.swap') return
...
export async function handleSwapTransfers(ctx: Context, block: Block, call: CallEntity): Promise<void> {

    if (call.kind !== 'call' || call.name !== 'LiquidityProxy.swap_transfer') return
