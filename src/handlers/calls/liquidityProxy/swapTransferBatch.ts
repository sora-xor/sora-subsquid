import { createCallHistoryElement, createEventHistoryElement } from '../../../utils/history'
...
export async function liquidityProxySwapTransferBatchCallHandler(ctx: BlockContext, call: Call<'LiquidityProxy.swap_transfer_batch'>): Promise<void> {
