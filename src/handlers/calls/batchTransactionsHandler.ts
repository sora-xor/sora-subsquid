...
export async function batchTransactionsHandler(ctx: Context, block: Block, call: CallEntity): Promise<void> {
    if (call.name !== 'Utility.batch_all') return
    ...
    const calls = (call.extrinsic as any).method.args[0] as Vec<CallBase<AnyTuple>>
